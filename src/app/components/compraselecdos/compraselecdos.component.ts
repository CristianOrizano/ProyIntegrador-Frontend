...
@Component({
  selector: 'app-compraselecdos',
  templateUrl: './compraselecdos.component.html',
  styleUrls: ['./compraselecdos.component.css']
})
export class CompraselecdosComponent {
  idproducto: number=0;
  cantidad:number=1;
  ...
  addtocart(){
    ...
    this.router.navigate(['iniicio/carro']);
